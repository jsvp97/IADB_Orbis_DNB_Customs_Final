...
| 2a'' | `docs/WP_draft_2026-09-18.pdf` | **the working-paper draft for Christian**: only the exhibits the review marks MOSTRAR (main text) and APOYO / APÉNDICE (appendix), clean captions, no reading guide; Overleaf source in `output/wp/overleaf_WP_draft*`; `python wp_build_overleaf.py draft` |
